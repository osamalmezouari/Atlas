...
function Searchbar() {
  return (
    <div className={'searchbar relative z-50 pb-5 px-2 grid grid-cols-2 grid-rows-2 w-9/12 m-auto text-white rounded-2xl mr-auto max-md:w-full max-md:grid-rows-[auto,1fr]'}>
