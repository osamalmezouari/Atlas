    ...
    <>
      ...
      <div
        ...
        <div
          ...
          <MdOutlinePets /></div>
        <button
          className={"bg-orange col-start-6 border-2 border-transparent rounded bg-findshap bg-contain w-full bg-center h-12 max-md:h-full flex items-center  justify-center max-md:col-start-3 max-md:row-span-3 "}>
          <IoSearch className={'text-2xl'} /></button>
      </div>
    </>
