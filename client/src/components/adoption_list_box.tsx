...
function AdoptionListBox() {
  return (
    <div className={'max-w-[370px] h-[450px] '}>
      <div className={'img drop-shadow-xl bg-adoptionlist border-[1px] border-dbleu absolute -z-10 bg-cover w-full max-w-[370px] bg-center rounded h-[350px]'}>
      ...
      <div
        className={"adoption_info drop-shadow-xl border-[1px] border-dbleu  w-10/12 m-auto rounded relative top-[300px] bg-white px-2 py-4 bg-findshap bg-contain"}>
        <p
